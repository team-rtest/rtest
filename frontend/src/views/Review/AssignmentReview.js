          ...
          {assignment.map((d) => {
            return (
              <Rtr>
                ...
                <Rtd data-label="Median Grade">{getMedian(getGradeList(d.submissions))}</Rtd>
                <Rtd data-label="Max Grade">{getMax(getGradeList(d.submissions))}</Rtd>
                <Rtd data-label="Min Grade">{getMin(getGradeList(d.submissions))}</Rtd>
              </Rtr>
            );
          })}
        </ReviewTbody>
